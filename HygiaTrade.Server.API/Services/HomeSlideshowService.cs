...
public interface IHomeSlideshowService
{
    ...
    Task<HomeSlideshowPayload> UpdateAsync(HomeSlideshowPayload payload);
}
...
public sealed class HomeSlideshowService(
    ApplicationDbContext db) : IHomeSlideshowService
{
    ...
    public async Task<HomeSlideshowPayload> GetAsync()
    {
        ...
        return await ReadAsync() ?? CreateDefaultPayload();
    }
    ...
    private static void NormalizeSlides(HomeSlideshowPayload payload)
    {
    ...
    private async Task<HomeSlideshowPayload?> ReadAsync()
    {
        ...
        try
        {
            ...
            return string.IsNullOrWhiteSpace(json)
                ? null
                : JsonSerializer.Deserialize<HomeSlideshowPayload>(
                    json,
                    JsonOptions);
        }
        finally
